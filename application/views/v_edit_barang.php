...
<?php echo $peminjaman1;?>
      <form class="form-horizontal" action="<?php echo base_url('barang/edit/'.$kd_barang); ?>" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" class="form-control" name="ws_kode" value="<?php echo $kd_barang; ?>" placeholder="Masukan Kode Barang" required>
          ...
          <div class="form-group">
            <label for="inputUserName" class="col-sm-3">Lokasi Barang *</label>
            <div class="col-sm-8">
              <input type="text" class="form-control" name="ws_lokasi" value="<?php echo $lk_barang; ?>" placeholder="Lokasi Barang" required>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="number" class="form-control" name="ws_jumlah" placeholder="0">
