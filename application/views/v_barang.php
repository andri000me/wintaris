    ...
    <tbody>
      ...
      ?>
        <tr>
          ...
          <?php else:?>
            <td><img width="40" height="40" class="img-circle" src="<?php echo base_url('assets/foto/barang/'.$foto); ?>"></td>
          <?php endif;?>
    ...
    <div class="modal-content">
      ...
      <form class="form-horizontal" action="<?php echo base_url('barang/add');?>" method="post" enctype="multipart/form-data">
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="inputUserName" class="col-sm-4 control-label">Lokasi Barang *</label>
            <div class="col-sm-7">
              <input type="text" class="form-control" name="ws_lokasi" placeholder="Lokasi Barang" required>
            </div>
          </div>
